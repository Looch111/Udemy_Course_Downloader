...
const ENDPOINTS = {
  ...
  curriculum: (courseId, page = 1, pageSize = 100) =>
    `${BASE}/courses/${courseId}/cached-subscriber-curriculum-items/?page_size=${pageSize}&page=${page}&fields[lecture]=id,title,object_index,asset,supplementary_assets&fields[chapter]=id,title,object_index,sort_order&fields[asset]=id,asset_type,time_estimation,download_urls,external_url,slide_urls,filename&fields[quiz]=id,title,object_index,supplementary_assets&fields[practice]=id,title,object_index,supplementary_assets`,

  /** Single lecture detail */
  lectureDetail: (courseId, lectureId) =>
    `${BASE}/courses/${courseId}/lectures/${lectureId}/?fields[lecture]=id,title,asset,supplementary_assets&fields[asset]=id,asset_type,download_urls,stream_urls,external_url,slide_urls,filename,captions`,
